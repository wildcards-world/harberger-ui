...
import * as UserProvider from "./js/user-provider/UserProvider";
...
function useDisplayName(ethAddress) {
  ...
  var opt3box = Globals$WildCards.$less$$great(
    Js_dict.get(userContext.userInfo, ethAddressLower),
    function (a) {
      return a.threeBox;
    }
  );
  var opt3boxName = Globals$WildCards.$great$great$eq(
    Globals$WildCards.$great$great$eq(opt3box, function (a) {
      return a.profile;
    }),
    function (a) {
      return a.name;
  ...
  return Belt_Option.mapWithDefault(
    ...
    Belt_Option.mapWithDefault(
      Globals$WildCards.$less$$great(
        Globals$WildCards.$great$great$eq(
          Globals$WildCards.$great$great$eq(opt3box, function (a) {
      ...
      /* EthAddress */ Block.__(2, [ethAddress]),
      function (a) {
...
/* ./UserProvider Not a pure module */
